...
## 1. Metadata
*   **Subject ID:** `forste-verdenskrig`
*   **Topic ID:** `historie`
*   **Visual Theme:** `Gritty Industrial, High-Contrast Black/White with isolated Red, Mud & Steel textures.`
*   **Target Audience:** `10th Grade / VGS (Age 15-18)`
...
**The Hook:**
"The war that was supposed to end by Christmas ended up burying a generation in mud."

**The Arc:**
We start with the naive enthusiasm of 1914 ("The Adventure"), descend into the mechanical dehumanization of the trenches (1915-1917), and conclude with the shattered, cynical world of 1918 that set the stage for total collapse in 1939.

---

## 3. The Learning Path (The Spine)
> *Existing path `ww1-sti` is linear and text-heavy. Plan to inject interactivity.*

1.  **[Type: Article]** `Opptakt: Kruttønnen Europa` (ID: `opptakt`)
2.  **[Type: Introduction]** `Sivilisasjonens sammenbrudd` (ID: `intro`)
3.  **[Type: Deep Dive]** `Skyttergravskrig: Livet i gjørma` (ID: `skyttergravskrig`) - *NEEDS EXPANSION*
4.  **[Type: Interactive]** `Teknologiens dødsdans` (ID: `teknologi`)
5.  **[Type: Deep Dive]** `Rød Storm: Den Russiske Revolusjon` (ID: `russiske-revolusjon`) - *NEW*
6.  **[Type: Article]** `Hjemmefronten og Propaganda` (ID: `hjemmefronten`, `propaganda`) - *NEEDS EXPANSION*
7.  **[Type: Article]** `Norge: Den nøytrale allierte` (ID: `norge-under-ww1`) - *NEW*
8.  **[Type: Deep Dive]** `Mytteri og Forræderi: Den Tyske Revolusjon` (ID: `tyske-revolusjon`) - *NEW*
9.  **[Type: Reflection]** `Konsekvenser: En ny verden` (ID: `konsekvenser`)

---

## 4. The Content Matrix (The Bricks)

### Article 1: Opptakt (opptakt.json)
*   **Status:** Existing (Refine)
