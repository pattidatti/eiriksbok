...
const ChoiceButton = ({
    ...
    >
        <div className="flex items-center justify-between">
            ...
            {Icon && <Icon className={`h-6 w-6 ${selected ? 'text-white' : 'text-slate-500 group-hover:text-indigo-400'}`} />}
        </div>
        {subtext && <p className={`text-xs mt-1 ${selected ? 'text-indigo-200' : 'text-slate-500'}`}>{subtext}</p>}
    </button>
);
    ...
    return (
        <div className="w-full max-w-7xl mx-auto p-4 md:p-8">
            ...
            <div className="flex flex-col md:flex-row justify-between items-center mb-10 gap-4">
                <div>
                    <h1 className="text-3xl font-bold text-white tracking-tight">Samfunnsbyggeren</h1>
                    <p className="text-slate-400">Utforsk styringsformer, makt og økonomi</p>
                </div>
                <div className="flex flex-wrap gap-2 bg-slate-900/80 p-1.5 rounded-xl border border-white/10">
                    {[
            ...
            <div className="grid grid-cols-1 gap-8">
                ...
                {activeTab === 'utforsk' && (
                    <div className="grid grid-cols-1 lg:grid-cols-12 gap-8">
                        ...
                        <div className="lg:col-span-5 space-y-6">
                            ...
                            <div className="bg-slate-900/50 p-6 rounded-2xl border border-white/10 backdrop-blur-md shadow-xl">
                            ...
                            <AnimatePresence mode="wait">
                                ...
                                {whoRules === 'ingen' && (
                                    <motion.div
                                        ...
                                        className="bg-slate-900/50 p-6 rounded-2xl border border-white/10 backdrop-blur-md shadow-xl"
                                    >
                                    ...
                                    >
                                        ...
                                        {oneRulerSource === 'makt' && (
                                            <motion.div
                                                ...
                                                className="bg-slate-900/50 p-6 rounded-2xl border border-white/10 backdrop-blur-md shadow-xl border-l-4 border-l-red-500"
                                            >
                                ...
                                {whoRules === 'alle' && (
                                    ...
                                    >
                                        ...
                                        {headOfState === 'president' && (
                                            <motion.div
                                                initial={{ opacity: 0, y: 10 }} animate={{ opacity: 1, y: 0 }}
                                                className="bg-slate-900/50 p-6 rounded-2xl border border-white/10 backdrop-blur-md shadow-xl border-l-4 border-l-indigo-500"
                                            >
                                ...
                                <AnimatePresence mode="wait">
                                    {result ? (
                                        <motion.div
                                            ...
                                            className="w-full bg-slate-800/80 rounded-3xl border border-white/10 p-8 md:p-12 text-center flex flex-col items-center shadow-2xl relative overflow-hidden group min-h-[500px]"
                                        >
                                            {/* Bakgrunns-effekt */}
                                            <div className={`absolute inset-0 opacity-20 blur-3xl bg-gradient-to-t from-transparent via-${result.color.replace('text-', '')} to-transparent`} />
                                            ...
                                            <div className="relative z-10 w-full h-full flex flex-col items-center justify-center">
                                                <motion.div
                                                    ...
                                                    className={`p-6 rounded-full bg-white/5 border border-white/10 mb-8`}
                                                >
                                                    <result.icon className={`h-24 w-24 ${result.color}`} />
                                                </motion.div>

                                                <span className="text-sm font-bold uppercase tracking-widest text-slate-500 mb-2">{result.category}</span>
                                                <h2 className="text-4xl md:text-6xl font-black text-white mb-6 tracking-tight leading-tight">
                                                    {result.title}
                                                </h2>

                                                <div className="max-w-xl space-y-6">
                                                    <p className="text-slate-200 text-xl md:text-2xl leading-relaxed font-light">
                                                        {result.description}
                                                    </p>
                                                    <div className="bg-slate-900/60 p-6 rounded-xl border border-white/5 text-left">
                                        ...
                                        <motion.div
                                            initial={{ opacity: 0 }}
                                            animate={{ opacity: 1 }}
                                            className="w-full h-full min-h-[500px] bg-slate-900/30 rounded-3xl border-2 border-dashed border-white/5 flex flex-col items-center justify-center p-8 text-center"
                                        >
                                            <SparklesIcon className="h-20 w-20 text-slate-700 mb-6 animate-pulse" />
                                            <h3 className="text-2xl font-bold text-slate-500 mb-2">Din stat venter...</h3>
                ...
                {activeTab === 'maktbalanse' && (
                    <div className="max-w-6xl mx-auto space-y-8">
                        ...
                        <div className="bg-slate-900/50 border border-white/10 rounded-2xl p-6 backdrop-blur-md">
                            <h2 className="text-2xl font-bold text-white mb-2">Tre deler av makten</h2>
                        ...
                        <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                            ...
                            >
                                <div className="flex items-center gap-3 mb-2 relative z-10">
                                    <HandRaisedIcon className="h-6 w-6 text-indigo-400" />
                                    <span className="text-xl font-bold text-white">Parlamentarisme</span>
                                </div>
                                <p className="text-sm text-slate-400 relative z-10">Modell: Norge</p>
                            ...
                            >
                                <div className="flex items-center gap-3 mb-2 relative z-10">
                                    ...
                                    <span className="text-xl font-bold text-white">Ren Maktfordeling</span>
                                </div>
                                <p className="text-sm text-slate-400 relative z-10">Modell: USA</p>
                        ...
                        {/* Visualisering */}
                        <div className="bg-slate-900/80 rounded-3xl border border-white/10 p-8 h-[600px] relative overflow-hidden shadow-2xl">
                            ...
                            <svg className="absolute inset-0 w-full h-full pointer-events-none z-0">
                                ...
                                {balanceSystem === 'parlamentarisk' ? (
                                    <>
                                        ...
                                        <path d="M 500 150 Q 350 300 250 450" stroke="#6366f1" strokeWidth="12" fill="none" strokeDasharray="10,5" className="animate-pulse" opacity="0.4" />
                                        <text x="320" y="300" fill="#818cf8" fontSize="14" fontWeight="bold" transform="rotate(30 320,300)">Utgår fra</text>

                                        {/* Tynn linje til Dømmende */}
                                        <line x1="500" y1="150" x2="750" y2="450" stroke="#475569" strokeWidth="2" strokeDasharray="5,5" />
                                    </>
                                ) : (
                                    <>
                                        {/* Trekant med sperrer for maktfordeling */}
                                        <line x1="500" y1="150" x2="250" y2="450" stroke="#475569" strokeWidth="4" />
                                        <circle cx="375" cy="300" r="15" fill="#1e293b" stroke="#ef4444" strokeWidth="2" /> {/* Sperre */}

                                        <line x1="500" y1="150" x2="750" y2="450" stroke="#475569" strokeWidth="4" />
                                        <circle cx="625" cy="300" r="15" fill="#1e293b" stroke="#ef4444" strokeWidth="2" /> {/* Sperre */}

                                        <line x1="250" y1="450" x2="750" y2="450" stroke="#475569" strokeWidth="4" />
                                        <circle cx="500" cy="450" r="15" fill="#1e293b" stroke="#ef4444" strokeWidth="2" /> {/* Sperre */}
                                    </>
                                )}
                            </svg>
                            ...
                            <div className="absolute top-[10%] left-1/2 -translate-x-1/2 w-64 z-20">
                                <div className="bg-slate-800 rounded-xl border border-white/10 p-4 text-center shadow-xl relative group hover:scale-105 transition-transform">
                                    <div className="absolute -top-6 left-1/2 -translate-x-1/2 bg-slate-700 px-3 py-1 rounded-full text-xs font-bold text-white uppercase tracking-wider">Lovgivende</div>
                                    <BuildingLibraryIcon className="h-10 w-10 text-indigo-400 mx-auto mb-2" />
                            ...
                            <AnimatePresence>
                                ...
                                >
                                    <div className={`bg-slate-800 rounded-xl border p-4 text-center shadow-xl relative transition-all ${balanceSystem === 'parlamentarisk' ? 'border-indigo-500/50 shadow-indigo-500/20' : 'border-white/10'}`}>
                                        <div className="absolute -top-6 left-1/2 -translate-x-1/2 bg-slate-700 px-3 py-1 rounded-full text-xs font-bold text-white uppercase tracking-wider">Utøvende</div>
                                        <BuildingOfficeIcon className="h-10 w-10 text-green-400 mx-auto mb-2" />
                                        <h3 className="text-white font-bold text-lg">
                            ...
                            <div className="absolute bottom-[10%] right-[15%] w-64 z-20">
                                <div className="bg-slate-800 rounded-xl border border-white/10 p-4 text-center shadow-xl relative group hover:scale-105 transition-transform">
                                    <div className="absolute -top-6 left-1/2 -translate-x-1/2 bg-slate-700 px-3 py-1 rounded-full text-xs font-bold text-white uppercase tracking-wider">Dømmende</div>
                                    <ScaleIcon className="h-10 w-10 text-red-400 mx-auto mb-2" />
                                    <h3 className="text-white font-bold text-lg">
                ...
                {activeTab === 'quiz' && shuffledQuiz.length > 0 && (
                    <div className="max-w-3xl mx-auto w-full">
                        <div className="bg-slate-900/50 p-8 md:p-12 rounded-3xl border border-white/10 shadow-2xl backdrop-blur-md relative overflow-hidden">

                            {/* Quiz Header */}
                            <div className="flex justify-between items-center mb-10 border-b border-white/10 pb-6">
                                <div>
                                    <h2 className="text-2xl font-bold text-white">Gjett styringsformen</h2>
                                    <p className="text-slate-400 text-sm">Spørsmål {quizIndex + 1} av {shuffledQuiz.length}</p>
                                </div>
                                <div className="bg-slate-800 px-4 py-2 rounded-lg border border-white/10">
                                    <span className="text-indigo-400 font-bold text-lg">Poeng: {quizScore}</span>
                                </div>
                            </div>
                            ...
                            <div className="mb-12 text-center">
                                ...
                                <h3 className="text-slate-200 text-2xl md:text-3xl font-light leading-relaxed">
                            ...
                            <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                                {(() => {
                                    ...
                                    return options.map((option) => {
                                        let btnClass = "bg-slate-800/50 border-white/10 hover:bg-slate-700 hover:border-white/30";
                                        let icon = null;
                                        ...
                                        if (quizAnswered) {
                                            if (option.id === currentQ.id) {
                                                ...
                                                btnClass = "bg-slate-800/20 border-white/5 opacity-40";
                                        ...
                                        return (
                                            ...
                                            >
                                                <span className={quizAnswered && option.id === currentQ.id ? 'text-green-300' : 'text-slate-300'}>
                                                    {option.title}
                                                </span>
                                                {icon}
                                            </button>
                            ...
                            <AnimatePresence>
                                {quizAnswered && (
                                    ...
                                    >
                                        <div className={`mb-6 px-6 py-3 rounded-full flex items-center gap-3 ${quizCorrect ? 'bg-green-500/10 text-green-400 border border-green-500/20' : 'bg-red-500/10 text-red-400 border border-red-500/20'}`}>
                    ...
                    <div className="space-y-16">
                        ...
                        <div className="max-w-md mx-auto relative">
                            <input
                                ...
                                className="w-full bg-slate-900 border border-white/10 rounded-xl py-3 px-5 text-white focus:outline-none focus:border-indigo-500 transition-colors"
                            />
                        ...
                        <div>
                            <div className="flex items-center mb-8 gap-4 border-b border-white/5 pb-4">
                                <div className="p-3 bg-indigo-500/20 rounded-xl">
                                    <GlobeAmericasIcon className="h-8 w-8 text-indigo-400" />
                                </div>
                                <div>
                                    <h2 className="text-3xl font-bold text-white">Styringsformer</h2>
                                    <p className="text-slate-400">Hvordan makt organiseres i en stat</p>
                                </div>
                            </div>
                            ...
                            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
                                {definitions
                                    ...
                                    .map((gov) => (
                                        <div key={gov.id} className="bg-slate-900/50 border border-white/10 rounded-2xl p-6 hover:border-indigo-500/50 hover:bg-slate-800/80 transition-all group relative overflow-hidden">
                                            ...
                                            <div className="relative z-10">
                                                <div className="flex items-center gap-3 mb-4">
                                                    ...
                                                    <h3 className="text-xl font-bold text-white">{gov.title}</h3>
                                                </div>
                                                <p className="text-slate-300 text-sm leading-relaxed mb-4 min-h-[40px]">{gov.description}</p>
                        ...
                        <div>
                            <div className="flex items-center mb-8 gap-4 border-b border-white/5 pb-4">
                                ...
                                <div>
                                    <h2 className="text-3xl font-bold text-white">Økonomiske Systemer</h2>
                                    <p className="text-slate-400">Hvordan ressurser fordeles</p>
                                </div>
                            </div>
                            ...
                            <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
                                {definitions
                                    ...
                                    .filter(d => d.title.toLowerCase().includes(searchQuery.toLowerCase()))
                                    .map((eco) => (
                                        <div key={eco.id} className="bg-slate-900/50 border border-white/10 rounded-2xl p-6 hover:border-green-500/50 transition-all">
                                            <h3 className={`text-xl font-bold mb-3 ${eco.color}`}>{eco.title}</h3>
                                            <p className="text-white text-sm mb-3">{eco.description}</p>
                                            <p className="text-slate-400 text-xs leading-relaxed">{eco.details}</p>
                                        </div>
                                    ))}
                            </div>
                        </div>
                        ...
                        <div>
                            <div className="flex items-center mb-8 gap-4 border-b border-white/5 pb-4">
                                ...
                                <div>
                                    <h2 className="text-3xl font-bold text-white">Viktige Begreper</h2>
                                    <p className="text-slate-400">Nøkkelord for å forstå politikk</p>
                                </div>
                            </div>
                            ...
                            <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
                                {definitions
                                    ...
                                    .filter(d => d.title.toLowerCase().includes(searchQuery.toLowerCase()))
                                    .map((term) => (
                                        <div key={term.id} className="bg-slate-800/30 border border-white/5 rounded-2xl p-6 hover:bg-slate-800/50 transition-colors">
                                            <h3 className="text-lg font-bold text-white mb-2">{term.title}</h3>
                                            <p className="text-slate-300 text-sm mb-2">{term.description}</p>
