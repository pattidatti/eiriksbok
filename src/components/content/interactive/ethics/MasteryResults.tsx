...
export const MasteryResults: React.FC<MasteryResultsProps> = ({ score, total, systemId, onReset }) => {
    ...
    return (
        <div className="max-w-3xl mx-auto py-12">
            ...
            >
                <div className="inline-flex items-center justify-center w-24 h-24 rounded-full bg-indigo-500/20 text-indigo-400 mb-6 border border-indigo-500/30">
                    <Award size={48} />
                </div>
                <h2 className="text-4xl font-display font-black mb-4">Resultat: {system?.name}</h2>
                <div className="text-6xl font-black text-white mb-6">
                    {score} <span className="text-slate-500 text-3xl">/ {total}</span>
                </div>
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-6 mb-12">
                <div className="p-8 rounded-[2rem] bg-white/5 border border-white/10">
                    ...
                    <a
                        ...
                        className="inline-flex items-center gap-2 text-indigo-400 font-bold hover:text-indigo-300 transition-colors py-2 px-4 rounded-xl bg-indigo-500/10 border border-indigo-500/20"
                    >
                        Les full fordypning <ArrowRight size={16} />
                    </a>
                </div>

                <div className="p-8 rounded-[2rem] bg-white/5 border border-white/10 flex flex-col justify-center items-center text-center">
                    <div className="relative w-32 h-32 mb-4">
                        <svg className="w-full h-full" viewBox="0 0 100 100">
                            ...
                            <circle
                                ...
                                strokeLinecap="round"
                                className="text-indigo-500 -rotate-90 origin-center transition-all duration-1000"
                            />
                        </svg>
            ...
            <div className="flex flex-col sm:flex-row gap-4 justify-center">
                ...
                <button
                    onClick={onReset}
                    className="px-8 py-4 rounded-xl bg-white/5 border border-white/10 text-white font-black uppercase tracking-widest text-xs hover:bg-white/10 transition-all flex items-center justify-center gap-2"
                >
                    Hovedmeny
                </button>
            </div>
