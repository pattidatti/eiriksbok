                    ...
                    {events.map((event, index) => (
                        <div key={index} className="relative group">
                            ...
                            <div className="mb-0.5">
                                <span className="inline-block px-1.5 py-0 bg-indigo-50 text-indigo-700 text-[9px] font-bold rounded-full mb-0.5">
                                    {event.year}
                                </span>
                                {event.link ? (
                        ...
                        >
                            ...
                            <div className="ml-12 md:ml-0 md:w-1/2 md:px-8 group">
                                <div className={`relative p-5 rounded-xl bg-surface-card border border-white/5 hover:border-neon-accent/30 transition-all duration-300 hover:shadow-[0_0_20px_rgba(99,102,241,0.05)] ${index % 2 === 0 ? 'md:text-left' : 'md:text-right'
                                    ...
                                    <span className="inline-block px-2 py-0.5 bg-neon-accent/10 text-neon-accent text-xs font-mono font-bold rounded border border-neon-accent/20 mb-2 shadow-[0_0_8px_rgba(99,102,241,0.15)]">
                                        {event.year}
                                    </span>
