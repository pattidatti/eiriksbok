...
import { Guitar, Piano, Music2 } from 'lucide-react';
...
export const ChordLibrary: React.FC = () => {
    ...
    const guitarVoicing = useMemo(() => {
        ...
        return getGuitarVoicing(root, quality);
    ...
    return (
        <div className="w-full max-w-7xl mx-auto space-y-8 py-8">
            ...
            <div className="grid grid-cols-1 lg:grid-cols-12 gap-6 min-h-[600px]">
                ...
                {/* Left Panel: Controls */}
                <div className="lg:col-span-4 bg-white/80 backdrop-blur-xl rounded-[2.5rem] p-8 border border-white/20 shadow-xl shadow-indigo-100/50 flex flex-col justify-center relative overflow-hidden group">
                ...
                <div className="lg:col-span-8 bg-slate-50/50 backdrop-blur-sm rounded-[2.5rem] p-10 border border-white/50 shadow-2xl shadow-slate-200/50 flex flex-col items-center justify-center relative overflow-hidden">
