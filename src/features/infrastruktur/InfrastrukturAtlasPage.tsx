...
export function InfrastrukturAtlasPage() {
    ...
    return (
        <div className="flex flex-col h-screen bg-[#0b1120] text-white overflow-hidden">
            {/* Header */}
            <header className="flex items-center justify-between px-4 py-3 bg-slate-900/80 border-b border-slate-800 flex-shrink-0 z-10">
                <div className="flex items-center gap-3">
                    ...
                    <div>
                        ...
                        <p className="text-xs text-slate-400 mt-0.5">Verdens årer — handel, energi og data</p>
                    </div>
                </div>

                {/* Mobile layer toggle */}
                <button
                    className="md:hidden flex items-center gap-1.5 text-xs bg-slate-700 px-3 py-1.5 rounded-lg"
