...
export const INITIAL_RESOURCES: Record<Role, Resources> = {
    KING: { gold: 1000, grain: 500, flour: 200, bread: 50, wood: 200, timber: 50, iron_ore: 0, iron_ingot: 20, stone: 100, swords: 50, armor: 20, favor: 0, wool: 50, cloth: 20, honey: 0, meat: 0, glass: 0, manpower: 0 },
    BARON: { gold: 300, grain: 100, flour: 50, bread: 20, wood: 50, timber: 20, iron_ore: 0, iron_ingot: 10, stone: 20, swords: 10, armor: 10, favor: 0, wool: 20, cloth: 5, honey: 0, meat: 0, glass: 0, manpower: 0 },
    PEASANT: { gold: 20, grain: 30, flour: 5, bread: 5, wood: 0, timber: 0, iron_ore: 0, iron_ingot: 0, stone: 0, swords: 0, armor: 0, favor: 0, wool: 10, cloth: 0, honey: 0, meat: 0, glass: 0, manpower: 0 },
    SOLDIER: { gold: 50, grain: 10, flour: 10, bread: 10, wood: 0, timber: 0, iron_ore: 0, iron_ingot: 0, stone: 0, swords: 5, armor: 2, favor: 0, wool: 0, cloth: 0, honey: 0, meat: 0, glass: 0, manpower: 0 },
    MERCHANT: { gold: 500, grain: 50, flour: 50, bread: 20, wood: 50, timber: 20, iron_ore: 0, iron_ingot: 5, stone: 50, swords: 5, armor: 2, favor: 0, wool: 20, cloth: 10, honey: 0, meat: 0, glass: 0, manpower: 0 }
};
...
export const ITEM_TEMPLATES: Record<string, ItemTemplate> = {
    ...
    stone_axe: { id: 'stone_axe', name: 'Steinøks', icon: '🪓', type: 'AXE', durability: 30, maxDurability: 30, level: 1, description: 'Primitiv øks. +1 Utbytte ved tømmerhogst.', stats: { yieldBonus: 1 }, relevantActions: ['CHOP'], nextTierId: 'iron_axe' },
    stone_pickaxe: { id: 'stone_pickaxe', name: 'Steinhakke', icon: '⛏️', type: 'PICKAXE', durability: 30, maxDurability: 30, level: 1, description: 'Enkel hakke. +1 Utbytte ved gruvedrift.', stats: { yieldBonus: 1 }, relevantActions: ['MINE', 'QUARRY'], nextTierId: 'iron_pickaxe' },
    rusty_axe: { id: 'rusty_axe', name: 'Rusten Øks', icon: '🪓', type: 'AXE', durability: 50, maxDurability: 50, level: 1, description: 'Gammel og sløv. Gir ingen utbytte-bonus.', stats: { yieldBonus: 0 }, relevantActions: ['CHOP'], nextTierId: 'stone_axe' },
    iron_axe: { id: 'iron_axe', name: 'Jernøks', icon: '🪓', type: 'AXE', durability: 100, maxDurability: 100, level: 3, description: 'Solid jernøks. +3 Utbytte ved tømmerhogst.', stats: { yieldBonus: 3 }, relevantActions: ['CHOP'], nextTierId: 'steel_axe' },
    iron_pickaxe: { id: 'iron_pickaxe', name: 'Jernhakke', icon: '⛏️', type: 'PICKAXE', durability: 100, maxDurability: 100, level: 3, description: 'Effektiv hakke. +3 Utbytte ved gruvedrift.', stats: { yieldBonus: 3 }, relevantActions: ['MINE', 'QUARRY'], nextTierId: 'steel_pickaxe' },
