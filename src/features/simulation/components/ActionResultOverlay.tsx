        ...
        <AnimatePresence>
            {result && (
                <motion.div
                    ...
                    className="absolute top-[25%] left-1/2 transform -translate-x-1/2 bg-slate-900/95 border-2 border-amber-500/30 p-6 rounded-3xl shadow-[0_0_50px_rgba(0,0,0,0.5)] backdrop-blur-md min-w-[340px] text-center z-50 overflow-hidden"
                >
                    ...
                    <div className="relative z-10">
                        {/* Message Header */}
                        <div className={`text-xl font-black mb-4 tracking-tight ${result.success ? 'text-white' : 'text-rose-400'}`}>
                            {result.message}
                        </div>
