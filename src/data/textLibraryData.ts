...
export const textLibraryData: TextEntry[] = [
    {
        id: 'ki-botox',
        title: 'KI er Botox for hjernen',
        author: 'Andreas Birger Johansen',
        genre: 'Kommentar',
        language: 'bm.',
        theme: ['Kunstig intelligens', 'Språk', 'Empati', 'Retorikk'],
        publishedYear: 2025,
        url: 'https://www.nrk.no/ytring/ki-er-botox-for-hjernen-1.17657427',
        definitions: [
            { term: 'Botox', definition: 'En nervegift som brukes kosmetisk for å glatte ut rynker ved å lamme muskulatur.' },
            { term: 'språkmodeller', definition: 'KI-systemer trent på store mengder tekst for å generere menneskelignende svar.' },
            { term: 'empati', definition: 'Evnen til å sette seg inn i og forstå andres følelser og perspektiver.' },
            { term: 'interagere', definition: 'Å samhandle eller virke sammen med andre.' },
            { term: 'populisme', definition: 'En politisk retning som vektlegger motsetningen mellom "folket" og "eliten".' },
            { term: 'nytteoptimaliserende', definition: 'Å handle på en måte som gir størst mulig nytte eller gevinst for seg selv.' },
            { term: 'dopaminrushet', definition: 'En intens følelse av velvære forårsaket av signalstoffet dopamin i hjernen.' }
        ],
        content: [
            "Bruker du en KI til å skrive for deg, ender du gjerne med en pen og glatt tekst – like død som en Botox-panne.",
            "Botox kan slette rynkene i fjeset ditt, og språkmodeller kan fikse dårlig grammatikk og manglende flyt i teksten din. Men bra blir det ikke, skriver kronikkforfatteren.",
            ...
            "På tross av mangfoldige advarsler, øker bruken av KI overalt. Hvorfor? Fordi vi er nytteoptimaliserende skapninger. Det er menneskelig å benytte seg av lettvinte løsninger. Men evolusjonen har også satt oss i stand til å overstyre våre primale instinkter og velge den tyngre, men riktigere veien.",
        ...
        reflectionTasks: [
            "Hva mener forfatteren med metaforen 'Botox for hjernen'?",
            "Hvorfor mener forfatteren at vi blir 'dummere' av å bruke KI til skriving?",
            "Forfatteren skriver at 'det er det menneskelige som berører oss'. Er du enig i at vi kan merke om en tekst er skrevet av et menneske eller en maskin?",
            "I hvilke situasjoner mener forfatteren at KI faktisk er en 'superkraft'?"
        ],
        lessonPlan: {
            learningObjectives: [
                "Reflektere kritisk over hvordan KI påvirker språket vårt og evnen vår til å tenke.",
                "Forstå og analysere bruken av metaforer i argumenterende tekster.",
                "Kunne delta i debatt om teknologiens plass i skolen og samfunnet."
            ],
            preReading: [
                "Klassediskusjon: Hva bruker dere KI til i hverdagen? Sparer det tid, eller gjør det dere latere?",
                "Hva forbinder dere med ordet 'Botox'? Hvorfor tror dere forfatteren bruker dette ordet om KI?"
            ],
            whileReading: [
                "Marker ord eller uttrykk du ikke forstår helt (se gjerne på forklaringene i teksten).",
                "Finn hovedargumentet i teksten. Hva er det forfatteren prøver å overbevise oss om?"
            ],
            postReading: [
                "Diskuter i grupper: Forfatteren hevder at man blir mindre empatisk av Botox og kanskje også av KI. Hvordan kan mangel på motstand når vi skriver føre til mindre empati?",
                "Hvorfor er det viktig å 'kna og elte tankene' selv, ifølge teksten?"
            ],
            writingTask: "Skriv et svar på dette debattinnlegget. Er du enig eller uenig med Andreas Birger Johansen? Bruk egne erfaringer med KI som eksempler i teksten din."
        }
    },
    {
        id: 'en-middag',
