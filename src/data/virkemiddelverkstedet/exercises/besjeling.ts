...
export const besjelingExercises: Exercise[] = [
    ...
    },
    {
        ...
        data: {
            ...
            acceptKeywords: ['alene', 'øde', 'tom', 'vemodig', 'nedstemt', 'nedslagen', 'sorgfull'],
            hint: 'Gi lekeplassen en menneskelig følelse - hvordan virker den etter at barna har gått?',
    ...
    },
    {
        ...
        data: {
            ...
            acceptKeywords: ['stille', 'trygg', 'mett', 'glad', 'søvnig', 'trett', 'behagelig', 'lykkelig'],
            hint: 'Gi huset en følelse - hvordan kjennes det når alt endelig er stille?',
