...
export const metaforExercises: Exercise[] = [
    ...
    },
    {
        ...
        data: {
            ...
            acceptKeywords: ['toppen', 'rakett', 'sky', 'stjerne', 'himmel', 'vinner', 'dronning', 'konge', 'gull'],
            hint: 'Bruk en metafor for enorm glede. Hva kan hun sammenlignes med etter seieren?',
    ...
    },
    {
        ...
        data: {
            ...
            acceptKeywords: ['blank', 'åpen', 'ukjent', 'tom', 'uskrevet', 'hav', 'dør', 'sti', 'vei', 'mørk'],
            hint: 'Lag en metafor for det usikre og ukjente. Fremtiden var som...?',
