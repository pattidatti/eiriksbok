    ...
    nodes: [
        {
            ...
            x: 50, y: 50, size: 24,
            description: 'Filosofiens far. Stilte spørsmål i stedet for å gi svar, og tvang folk til å tenke selv.',
        ...
        },
        {
            ...
            keyIdea: 'Idélæren, Hulelignelsen',
            color: ERA_COLORS.antikken,
        },
        {
            id: 'aristoteles',
            ...
            x: 60, y: 30, size: 22,
            description: 'Systematiserte all kunnskap. Mente lykke kommer fra å leve balansert og bruke fornuften.',
        ...
        },
        {
            ...
            x: 30, y: 60, size: 16,
            description: 'Koblet kristen tro med gresk filosofi. Grublet over tid, fri vilje og menneskets natur.',
        ...
        },
        {
            ...
            x: 20, y: 20, size: 18,
            description: 'Tvilte på alt for å finne noe sikkert. Konkluderte: "Jeg tenker, derfor er jeg."',
        ...
        },
        {
            ...
            x: 70, y: 25, size: 18,
            description: 'Mente vi fødes som blanke ark. Forsvarte individets naturlige rettigheter.',
        ...
        },
        {
            ...
            x: 80, y: 20, size: 18,
            description: 'Den ultimate skeptikeren. Viste at vi ikke kan bevise årsak og virkning logisk.',
        ...
        },
        {
            ...
            x: 50, y: 15, size: 20,
            description: 'Forente fornuft og erfaring. Skapte universelle moralregler alle må kunne følge.',
        ...
        },
        {
            ...
            x: 85, y: 70, size: 18,
            description: 'Erklærte at "Gud er død" og utfordret all tradisjonell moral. Ba oss skape egne verdier.',
        ...
        },
        {
            ...
            x: 15, y: 75, size: 16,
            description: 'Eksistensialismens far. Mente at livets viktigste valg ikke kan løses med logikk.',
        ...
        },
        {
            ...
            x: 25, y: 80, size: 18,
            description: 'Spurte hva det betyr å "være". Mente at vi lever for mye på overflaten.',
            keyIdea: 'Dasein, Væren og tid',
            color: ERA_COLORS.moderne,
        },
        {
            id: 'arendt',
            ...
            x: 35, y: 85, size: 16,
            description: 'Studerte ondskap og makt. Viste at selv vanlige folk kan gjøre forferdelige ting.',
        ...
        },
        {
            ...
            keyIdea: '"Man fødes ikke som kvinne", Frihet',
            color: ERA_COLORS.moderne,
        },
        {
            id: 'mises',
            ...
            x: 75, y: 5, size: 16,
            description: 'Forsvarte frie markeder med filosofisk dybde. Mente økonomisk frihet er grunnleggende.',
        ...
        },
        {
            ...
            x: 85, y: 5, size: 16,
            description: 'Tok Mises videre og utfordret statens rett til å styre. Radikal frihetstanke.',
