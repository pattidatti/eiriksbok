...
export const ibnFadlanReisebeskrivelse: TextEntry = {
    id: 'ibn-fadlan-reisebeskrivelse',
    title: 'Ibn Fadlans reisebeskrivelse',
    ...
    definitions: [
        ...
        { term: "trellkvinne", definition: "En kvinnelig slave. I vikingtiden kunne treller kjøpes og selges." },
        { term: "Rus", definition: "Betegnelse brukt av arabiske forfattere om skandinaviske vikinger/handelsmenn i øst." },
        { term: "dødsengelen", definition: "En rituell leder, sannsynligvis en prestinne eller kultleder som styrte begravelsesseremonien." }
    ],
    content: [
        ...
        "Dette går for seg på følgende måte: for den fattige blant dem lager de et lite skip, legger ham i det, og brenner det. Men når det gjelder en rik mann, så samler de hele hans formue og deler den i tre like store deler. En tredjedel går til hans familie, for en annen tredjedel lager de lik-klær til ham, og for den siste tredjedelen brygger de <b>nabid</b> [visstnok nordisk øl], som de drikker den dag hans trellkvinne dreper seg, og blir brent sammen med sin herre. De er nemlig helt forfalne til nabid, som de drikker både natt og dag. Ofte er en av dem død med begeret i hånden.",
        ...
        "Så førte de henne opp til skipet, men lot henne ikke komme inn i teltet. Så kom mennene og hadde med seg skjold og tre(-staver), og rakte henne et beger med <b>nabid</b>. Hun sang over det, og drakk det ut.",
        ...
        "Endelig bygget de på det sted hvor skipet, som de hadde trukket opp fra floden, hadde stått, noe som lignet en rund haug. Midt på denne haugen reiste de en svær trestøtte av bjerketre. På den skrev de navnet på mannen, og navnet på <b>rus-kongen</b>, og så gikk de sin vei."
    ],
    lessonPlan: {
        learningObjectives: [
            "Forstå vikingenes gravskikker sett gjennom øynene til en utenlandsk observatør.",
            "Drøfte kildekritikk: Hvordan påvirker ibn Fadlans kultur hans beskrivelse?",
            "Reflektere over trellenes status og rituelle ofringer i vikingtiden."
        ],
        preReading: [
            "Hva vet du om hvordan vikingene begravde sine døde?",
            "Hvorfor tror du det var viktig for vikingene å få en 'god' død?"
        ],
        whileReading: [
            "Legg merke til rollen 'dødsengelen' spiller i ritualet.",
            "Hvilke reaksjoner viser ibn Fadlan på det han ser? Er han nøytral eller dømmende?",
            "Hva skjer med trellkvinnen, og hvordan reagerer hun gjennom prosessen?"
        ],
        postReading: [
            "Hvorfor tror du mannen av 'Rus' kaller araberne for 'dumme'?",
            "Hvilke deler av fortellingen virker troverdige, og hvilke kan være overdrivelser?",
            "Hvordan skiller dette ritualet seg fra dagens begravelsesskikker?"
        ],
        writingTask: "Skriv et dagboknotat fra perspektivet til en av de andre trellkvinnene som *ikke* meldte seg frivillig. Hva tenker du når du ser ritualet? Er du lettet, redd, eller sjalu?"
    }
};
